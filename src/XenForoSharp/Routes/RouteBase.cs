...
namespace XenForoSharp.Routes
{
    public abstract class RouteBase
    {
        ...
        protected async Task<RestResponse> ExecuteAsync(RestRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
            return await _client.ExecuteAsync(request, cancellationToken).ConfigureAwait(false);
        }

        protected async Task<T> ExecuteAsync<T>(RestRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Deserialize<T>(await ExecuteAsync(request, cancellationToken).ConfigureAwait(false));
        }
        ...
        protected async Task<UrlResponse> ExecuteUrlAsync(RestRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
